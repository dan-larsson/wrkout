...
import com.wrkout.activites.repetitive.BarbellSquat;
...
public class BarbellSquatTest {

    private BarbellSquat activity;
    ...
    @BeforeEach
    void setUp() {
        activity = new BarbellSquat(reps, sets, weight, today);
    }
