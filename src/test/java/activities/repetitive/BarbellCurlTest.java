...
import com.wrkout.activites.repetitive.BarbellCurl;
...
public class BarbellCurlTest {

    private BarbellCurl activity;
    private int sets = 1;
    private int reps = 2;
    ...
    @BeforeEach
    void setUp() {
        activity = new BarbellCurl(reps, sets, weight, today);
    }
